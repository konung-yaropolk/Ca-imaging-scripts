...
class Calc():
    ...
    def __init__(self, 
        ...
        self.CALM_PERIOD_AFTER_TRIG=CALM_PERIOD_AFTER_TRIG
        self.SKIP_AFTER_APPLICATION=SKIP_AFTER_APPLICATION
        self.YEILD_FIBERS=YEILD_FIBERS
        self.DEBUG=DEBUG
    ...
    def GetResult(self):
        ...
        for line in self.TODO_LIST_C:
            result = pd.concat([result, self.process_csv(line[0], **line[1])], axis=1)
    ...
    def process_csv(self, input, stim_A, stim_C, stim_AC, last_DRS=None):  # deleted arguments: appl_1, wout_1, appl_2, wout_2, appl_3, fibers,
